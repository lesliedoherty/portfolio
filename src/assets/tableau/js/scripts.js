...
(function ($) {
  $(document).ready(function () {
    ...
    if ($form.length && $cta.length) {
      isReveal = $form.hasClass('form-compact--reveal');
  ...
  $(document).ready(function () {
    ...
    $('.accordion .accordion__title-wrapper').click(function (e) {
      var $titleWrapper = $(this),
          $accordion = $titleWrapper.parents('.accordion'),
          $accordionItem = $titleWrapper.parents('.accordion__item'),
          $openItems = $accordion.find('.open.accordion__item').not($accordionItem);
      ...
      // Open new item.
      $titleWrapper.siblings('.accordion__content-wrapper').slideToggle(250, 'linear');
...
(function ($) {
  $(document).ready(function() {
     ...
     * Makes the assumption that there exists exactly one .table-list__link in a --clickable-row
     */
    $('.table-list--clickable-row tr').click(function (e) {
      ...
      // If there is no given target, open in the same winow using _self
      if (!target) {
        target = '_self';
      }
